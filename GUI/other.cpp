...
Other::Other(QWidget *parent, FileReader* fileReader, SearchEngine* searchEngine) :
    QDialog(parent),
    ui(new Ui::Other)
{
    ui->setupUi(this);
    ...
    this->setWindowTitle("Other Pets");
...
void Other::otherReceiveshow(){
    this->show();
}

void Other::on_toolButton_home_clicked()
{
    this->hide();
    emit otherShowmainwindow();

}
void Other::receivesTranslateToSpanish(){
...
void Other::receivesTranslateToEnglish(){
...
void Other::on_comboBox_Language_currentIndexChanged(int index)
{
    if(index == 1){
...
void Other::on_comboBoxStates_activated(const QString &arg1)
{
